export default function Testimonial() {
  return (
    <section className="relative mx-auto w-full max-w-6xl lg:max-w-7xl xl:max-w-[80rem] overflow-hidden rounded-xl shadow-2xl shadow-[#366A79]/70">

      {/* Background Video */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <video
          className="h-full w-full object-cover"
          src="/images/getstartedvid.mp4"
          autoPlay
          loop
          muted
          playsInline
      ...
      <div className="relative z-20 px-8 pb-28 pt-10 sm:px-14 sm:pb-28 sm:pt-14 lg:px-24 lg:pb-32 lg:pt-20">
        <blockquote className="relative max-w-3xl text-xl leading-relaxed tracking-tight text-white md:text-2xl lg:text-3xl">
      ...
      <div className="absolute bottom-5 left-5 right-5 z-30 sm:bottom-6 sm:left-10 sm:right-auto">
        <div className="flex items-center gap-4 rounded-2xl bg-white/95 px-5 py-3 shadow-2xl ring-1 ring-black/10 backdrop-blur-md sm:w-[26rem] md:w-[32rem] lg:w-[36rem]">
